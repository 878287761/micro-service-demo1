...
public class Consumer_DeptController {
     ...
     */
    private static final String REST_URL_PROVIDER_PREFIX = "http://MICROSERVICEPROVIDERDEPT";

    /**
     * RestTemplate 是一种简单便捷的访问 restful 服务模板类，是 Spring 提供的用于访问 Rest 服务的客户端模板工具集，
